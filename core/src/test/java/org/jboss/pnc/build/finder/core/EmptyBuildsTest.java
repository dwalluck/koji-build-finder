...
class EmptyBuildsTest {
    ...
    void testEmptyBuilds() throws KojiClientException, MalformedURLException {
        Checksum checksum1 = new Checksum(md5, "ca5330166ccd4e2b205bed4b88f924b0", "random.jar!random.jar", -1L);
        Checksum checksum2 = new Checksum(md5, "b3ba80c13aa555c3eb428dbf62e2c48e", "random.jar", -1L);
